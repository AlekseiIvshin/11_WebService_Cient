...
public abstract class ReportFacade {
	 ...
	 * @throws IOException
	 */
	public abstract void createReports() throws IOException;
	 ...
	 * @throws IOException
	 */
	public abstract void createReport(String... name) throws IOException;
	 ...
	 * @throws IOException
	 */
	public abstract void createReport(String reportName) throws IOException;
}
